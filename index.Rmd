...
This quesiton is of interest because we can analyze which genre is popular among all the different number of genres that are in todays music industry. Our data sets will support this by using Billboard's data for the top 50 songs for a particular years and then plug those songs into spotify to tell us the number of streams. 
...
This quesiton is of interest because we can compare top songs within genres, and compare that to popular genres. From this, we can assess how much influence the top songs within a genre have over the popularity of the entire genre. Our data sets will support this as we will utilize the popular songs with their genre tags associated with them. 

#### _Question 3_
How do the number of streams compare from 1950 to 2015?

This question is of interest because we can analyze the trends of users within the time frame of **_x_ year** to **_y_ year**). From the data we collect, we can assess the number of users, as well as analyze if streaming as a platform has increased.

#### _Question 4_
How do the rythm, pitch, and timbre compare across several different genres?

This question is of interest to analyze themes and motifs among different genres, and how similarities of songs' rhythm, pitch, and timbre may affect popularity within a particular genre. Our data sets will support this by providing values of pitch and timbre from Spotify's audio analysis for a particular song, chosen from the Billboard top 100. 
